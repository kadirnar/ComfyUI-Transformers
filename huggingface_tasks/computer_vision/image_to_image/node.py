...
class ImageToImagePipeline:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "image": ("IMAGE",),
                "model_name": ("STRING", {"default": "caidas/swin2SR-classical-sr-x2-64"}),
            },
        }
    ...
    CATEGORY = "Transformers/ImageToImage"
    ...
    def run_image_to_image(self, image, model_name):
        ...
        pipe = hf_pipeline("image-to-image", model=model_name, trust_remote_code=True)
